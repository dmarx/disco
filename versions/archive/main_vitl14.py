...
print(settings['clip_guidance_scale'])
print(settings['steps'])
print(settings['cut_ic_pow'])
print(settings['range_scale'])
print(settings['cutn_batches'])
print(settings)
...
if google_drive is True:
  drive.mount(settings['path'] + '/content/drive')
  root_path = settings['path'] + '/content/drive/MyDrive/AI/Disco_Diffusion'
else:
...
# %cd settings['path'] + '/content/latent-diffusion'
from functools import partial
from ldm.util import instantiate_from_config
from ldm.modules.diffusionmodules.util import make_ddim_sampling_parameters, make_ddim_timesteps, noise_like
# from ldm.models.diffusion.ddim import DDIMSampler
from ldm.util import ismap
# %cd settings['path'] + '/content'
...
diffusion_model = "512x512_diffusion_uncond_openimages_epoch28_withfilter" #"512x512_diffusion_uncond_finetune_008100" #@param ["256x256_diffusion_uncond", "512x512_diffusion_uncond_finetune_008100"]
...
model_512_path = f'{model_path}/512x512_diffusion_uncond_openimages_epoch28_withfilter.pt'
model_secondary_path = f'{model_path}/secondary_model_imagenet_2.pth'
model_secondary_path = f'{model_path}/yfcc_2.pth'
...
if animation_mode == "Video Input":
  videoFramesFolder = settings['path'] + '/content/videoFrames'
