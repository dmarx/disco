...
# all_title = "The ancient dome of Kublai Khan in the green hills and tropical forests surrounding Xanadu"
   ...
   # 'prompt': "A scenic view of a beautiful valley, by Asher Brown Durand, featured on ArtStation.",
    # 'prompt': "A scenic view from above the Alps, by Asher Brown Durand, featured on ArtStation.",
...
import clip
#from .res resize_right import resize
...
import warnings
os.system('warnings("ignore", category=UserWarning')
...
max_frames = 2000#@param {type:"number"}
...
translation_x = "0: (0), 2000: (100.0)"#@param {type:"string"}
