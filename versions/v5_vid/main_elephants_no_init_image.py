...
#         #'prompt': "A scenic view inside ice caves, by Asher Brown Durand, featured on ArtStation.",
#      'prompt':'Elephants drinking from a swimming pool outside a suburban house, by David Shepherd and Asher Brown Durand, featured on ArtStation.',
...
# init_image = "/notebooks/dev/disco/content/init_images/elephant2.jpg" #@param{type: 'string'}
...
# zoom = "0: (1), 50: (1.0)"#@param {type:"string"} # was 10
