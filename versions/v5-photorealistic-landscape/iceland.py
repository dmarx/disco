...
settings = {
 ...
 # 'prompt':"A scenic view of the Birds-nest monastery in Bhutan, by David Noton, detailed render, I can't believe how detailed this is, matte painting trending on artstation artstation HQ.",
   ...
   'prompt':"A scenic view of Vestur-Skaftafellssysla in Iceland, by Asher Brown Durand, detailed render, I can't believe how detailed this is, matte painting trending on artstation artstation HQ.",
    #Alien dreamscape in a futuristic city at night, by Daniel Ljunggren, featured on ArtStation
