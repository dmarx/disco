      ...
      'prompt':
            [
               # "A large and very detailed matte painting:8",
                "A view inside an artificial neural network, by Asher Brown Durand, matte painting trending on artstation HQ:10",
                #"by James Gurney. matte painting trending on artstation HQ:10",
...
for i in range(len(lines)) :
  ...
  a.append("by Asher Brown Durand, detailed render, I can't believe how detailed this is, matte painting trending on artstation artstation HQ.:8")
