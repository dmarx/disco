...
settings = {
   ...
   # 'prompt':"A fisheye lens view of a futuristic sci-fi city with towering skyscrapers, by Asher Brown Durand, detailed render, fisheye lens effect, I can't believe how detailed this is, matte painting trending on artstation artstation HQ.", #360 degree equirectangular image, 
     ...
     'prompt':"A 180 degree fisheye view of a modernist buildings overgrown with plants, by David Noton and by Asher Brown Durand, shadertoy, detailed render, I can't believe how detailed this is, matte painting trending on artstation artstation HQ.", #360 degree equirectangular image, 
...
init_image = "" #root_path + "/content/init_images/init-equi-square.jpg" #@param{type: 'string'}
...
translation_z = "0: (0.0)" #sz #"0: (0.0)" #0: (-10.0), 360: (-10)" #"0: (0.0)" #0: (1.0),360: (1.0)" # #"0: (10.0)"#@param {type:"string"}
rotation_3d_x = "0: (0)"#@param {type:"string"}
rotation_3d_y = sr#"0: (0)" ##@param {type:"string"}
