...
init_image = "/home/twmmason/dev/disco/content/init_images/woman.jpg"  #None #@param{type: 'string'}
init_scale = 1000 #@param{type: 'integer'}
skip_steps = 75 #@param{type: 'integer'}
...
video_init_path = "/home/twmmason/dev/disco/content/training.mp4" #@param {type: 'string'}
...
text_prompts = {
    ...
    0: ["A woman lying amongst many large snakes, tropical jungle, by Prateep Kochabua, artstation in matte painting"],
    100: ["This set of prompts start at frame 100","This prompt has weight five:5"],
}
