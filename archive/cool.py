...
if google_drive is not True:
  root_path = f'/home/twmmason/dev/disco/content/models'
  model_path = '/home/twmmason/dev/disco/content/models' 
...
# %cd '/home/twmmason/dev/disco/content/models'
...
# width_height = [2560, 1536]#@param{type: 'raw'}
...
init_image = None #"/home/twmmason/dev/disco/content/init_images/buildings-sci-fi-futuristic-city-digital-art-towers.jpg" #None #@param{type: 'string'}
...
text_prompts = {
    0: ["Modern architecture in a jungle landscape, volumetric light, dense tropical jungle, rendered in Unreal Engine, 4k resolution"],
    100: ["This set of prompts start at frame 100","This prompt has weight five:5"],
}


text_prompts = {
    0: ["Pencil drawing of impossible stairs made out of bricks, by M.C. Escher, featured on ArtStation"],
    100: ["This set of prompts start at frame 100","This prompt has weight five:5"],
}


text_prompts = {
    0: ["I can take it, The tougher it gets, the cooler I get, rendered in Unreal Engine, 4k resolution"],
    100: ["This set of prompts start at frame 100","This prompt has weight five:5"],
}

text_prompts = {
    0: ["Papua New Guinea Tropical Forest, Hyperrealistic, RTX on"],
    100: ["This set of prompts start at frame 100","This prompt has weight five:5"],
}
...
text_prompts = {
    0: ["Futuristic sci-fi city with towering skyscrapers and flying cars, Hyperrealistic, RTX on"],
    100: ["This set of prompts start at frame 100","This prompt has weight five:5"],
}

text_prompts = {
    0: ["alien landscape with artificial mountains, featured on ArtStation, RTX on"],
    100: ["This set of prompts start at frame 100","This prompt has weight five:5"],
}


# text_prompts = {
#     0: ["iceland fjords mountain landscape, blue sky,  featured on ArtStation"],
#     100: ["This set of prompts start at frame 100","This prompt has weight five:5"],
# }


# text_prompts = {
#     0: ["alt, HYPERREALISTIC LANDSCAPE PAINTINGS, 4k resolution"],
#     100: ["This set of prompts start at frame 100","This prompt has weight five:5"],
# }
