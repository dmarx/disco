      ...
      <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-body pt-15">
          ...
          <div class="d-flex flex-center flex-column mb-5">
            ...
            <!--begin::Position-->
            <div class="fs-5 fw-bold text-muted mb-6">Under Investigation</div>
            <!--end::Position-->
            ...
            <div class="d-flex flex-wrap flex-center">
              ...
              >
                ...
                <div class="fw-bold text-muted">Entities</div>
              </div>
              <!--end::Stats-->
              ...
              >
                <div class="fs-4 fw-bolder text-gray-700">
                  <span class="w-50px">25%</span>
                  <span class="svg-icon svg-icon-3 svg-icon-success">
                    <inline-svg src="media/icons/duotune/arrows/arr066.svg" />
                  </span>
                </div>
                <div class="fw-bold text-muted">Attributed</div>
              </div>
              <!--end::Stats-->
            </div>
            <!--end::Info-->
          ...
          <div id="kt_customer_view_details" class="collapse show">
            <div class="py-5 fs-6">
              <!--begin::Badge-->
              <div class="badge badge-light-info d-inline">Attributed from Search</div>
              <!--begin::Badge-->
              <!--begin::Details item-->
      ...
      <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0">
          <div class="card-title">
            <h3 class="fw-bolder m-0">Attribution Suggestions</h3>
          </div>
        </div>
        <!--end::Card header-->
        ...
        <div class="card-body pt-2">
            ...
            <div class="d-flex flex-stack flex-grow-1">
              ...
              <div class="fw-bold">
                <div class="fs-6 text-gray-700">
                  By enabling connectors, you will receive alerts for possible attribution updates.
                </div>
              </div>
              <!--end::Content-->
            </div>
          ...
          <div class="py-2">
            ...
            <div class="d-flex flex-stack">
              <div class="d-flex">
                <img
                  src="media/svg/misc/retweet.svg"
                  class="w-30px me-6"
                  alt=""
                />
...
export default defineComponent({
  ...
  setup() {
    onMounted(() => {
      setCurrentPageBreadcrumbs("Profile Details", ["Case", "Profiles"]);
    });
