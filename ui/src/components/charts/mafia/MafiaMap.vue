  ...
  <div class="row gy-5 gx-xl-8" style="height:100%;">
    ...
    <div class="col-xxl-3 h-100">
      <div class="card">
        ...
        <div class="card-body pt-2">
          <div class="cicontent">
            <p>Filter the connection graphy using the options below.</p>
            <fieldset>
              ...
              <div class="form-check form-check-custom form-check-solid form-check-sm">
                <input
                  ...
                  checked
                />
                <label class="form-check-label" for="batanesi">Batanesi</label>
              </div>
              <div class="form-check form-check-custom form-check-solid form-check-sm">
                <input
                  class="form-check-input checkbox-mafia"
                  ...
                  checked
                />
                <label class="form-check-label" for="mistretta">Mistretta</label>
              </div>
              <div class="form-check form-check-custom form-check-solid form-check-sm">
                <input class="form-check-input checkbox-mafia" type="checkbox" id="none" checked />
                <label class="form-check-label" for="none">Unaffiliated</label>
              </div>

              <!-- <dl class="half-span">
                <label class="checkbox">
                  <input id="batanesi" class="checkbox-mafia" type="checkbox" name="family" checked />
                  <div class="batanesi">
                    <dt>&nbsp;</dt>
                    <dd>Batanesi</dd>
                  </div>
              ...
              <dl class="half-span">
                <label class="checkbox">
                  <input id="none" class="checkbox-mafia" type="checkbox" name="family" checked />
                  <div class="none">
                    <dt>&nbsp;</dt>
                    <dd>Unaffiliated</dd>
                  </div>
