  ...
  <div class="timeline">
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-content mb-10 mt-n1">
                    ...
                    <div class="pe-3 mb-5">
                      ...
                      >There are 2 new tasks for you regarding Data Ingestion:</div>
                      <!--end::Title-->
                      <!--begin::Description-->
                    ...
                    <div class="overflow-auto pb-5">
                      ...
                      >
                        ...
                        >Approve pending CDR data</a>
                        <!--end::Title-->
                        <!--begin::Label-->
                        <div class="min-w-175px pe-2">
                          <span class="badge badge-light text-muted">CDR Uploads</span>
                        </div>
                        <!--end::Label-->
                        <!--begin::Users-->
                        <div
                      ...
                      >
                        ...
                        <a
                          href="/metronic8/demo1/../demo1/apps/projects/project.html"
                          class="fs-5 text-dark text-hover-primary fw-bold w-375px min-w-200px"
                        >Review OSINT suggestions</a>
                        <!--end::Title-->
                        <!--begin::Label-->
                        <div class="min-w-175px">
                          <span class="badge badge-light text-muted">Search</span>
                        </div>
                        <!--end::Label-->
                        <!--begin::Users-->
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-content mb-10 mt-n2">
                    ...
                    <div class="overflow-auto pe-3">
                      <!--begin::Title-->
                      <div class="fs-5 fw-bold mb-2">Work Log added to case by Captain John Doe</div>
                      <!--end::Title-->
                      <!--begin::Description-->
                      <div class="d-flex align-items-center mt-1 fs-6">
                        <!--begin::Info-->
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-content mb-10 mt-n1">
                    ...
                    <div class="mb-5 pe-3">
                      ...
                      >3 New Discover Files Ingested:</a>
                      <!--end::Title-->
                      <!--begin::Description-->
                      <div class="d-flex align-items-center mt-1 fs-6">
                        <!--begin::Info-->
                        ...
                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                          ...
                          <div class="ms-1 fw-bold">
                            ...
                            <a
                              href="#"
                              class="fs-6 text-hover-primary fw-bolder"
                            >Suspicious Activity 2022-12-12</a>
                            <!--end::Desc-->
                            <!--begin::Number-->
                        ...
                        <div class="d-flex flex-aligns-center">
                          ...
                          <div class="ms-1 fw-bold">
                            ...
                            <a
                              href="#"
                              class="fs-6 text-hover-primary fw-bolder"
                            >Bank Statements for James Smith</a>
                            <!--end::Desc-->
                            <!--begin::Number-->
                  ...
                  <div class="timeline-content mb-10 mt-n1">
                    ...
                    <div class="pe-3 mb-5">
                      ...
                      <div class="fs-5 fw-bold mb-2">
                        Task
                        <a href="#" class="text-primary fw-bolder me-1">#45890</a>attached to subject
                        <a
                          href="#"
                          class="text-primary fw-bolder me-1"
                        >John Johnson</a>in: Attribution
                      </div>
                      <!--end::Title-->
                      <!--begin::Description-->
                      <div class="d-flex align-items-center mt-1 fs-6">
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-content mb-10 mt-n1">
                    ...
                    <div class="pe-3 mb-5">
                      <!--begin::Title-->
                      <div class="fs-5 fw-bold mb-2">3 new captures added to case:</div>
                      <!--end::Title-->
                      <!--begin::Description-->
                      <div class="d-flex align-items-center mt-1 fs-6">
                        <!--begin::Info-->
                        ...
                        <div class="overlay me-10">
                          ...
                          <div class="overlay-wrapper">
                            <img
                              ...
                              src="https://blog.shortpixel.com/wp-content/uploads/2017/06/image3.jpg"
                            />
                          </div>
                          <!--end::Image-->
                          <!--begin::Link-->
                        ...
                        <div class="overlay me-10">
                          ...
                          <div class="overlay-wrapper">
                            <img
                              alt="img"
                              class="rounded w-150px"
                              src="https://logmeincdn.azureedge.net/sc-grasshoppermedia/-/media/b0cb9f2d72fa4b33bcc414861fa768e1.png?la=en"
                            />
                          </div>
                          <!--end::Image-->
                          <!--begin::Link-->
                        ...
                        <div class="overlay">
                          ...
                          <div class="overlay-wrapper">
                            <img
                              alt="img"
                              class="rounded w-150px"
                              src="https://www.majik-websites.co.uk/wp-content/uploads/2020/07/design-development.jpg"
                            />
                          </div>
                          <!--end::Image-->
                          <!--begin::Link-->
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-content mb-10 mt-n1">
                    ...
                    <div class="pe-3 mb-5">
                      <!--begin::Title-->
                      <div class="fs-5 fw-bold mb-2">
                        New evidence manager assigned to subject
                        <a
                          href="#"
                          class="text-primary fw-bolder me-1"
                        >#67890</a>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-content mb-10 mt-n1">
                    ...
                    <div class="pe-3 mb-5">
                      ...
                      <div
                        class="fs-5 fw-bold mb-2"
                      >New data received and processed from internal records system:</div>
                      <!--end::Title-->
                      <!--begin::Description-->
                      <div class="d-flex align-items-center mt-1 fs-6">
                        <!--begin::Info-->
                      ...
                      >
                        ...
                        <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                          ...
                          <div class="mb-3 mb-md-0 fw-bold">
                            <h4 class="text-gray-900 fw-bolder">Data Ingestion Completed!</h4>
                            <div
                              class="fs-6 text-gray-700 pe-7"
                            >Review new data and see ingestion logs for a summary.</div>
                          </div>
                          <!--end::Content-->
                          <!--begin::Action-->
                          <a
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-content mt-n1">
                    ...
                    <div class="pe-3 mb-5">
                      ...
                      <div class="fs-5 fw-bold mb-2">
                        New entity
                        <a href="#" class="text-primary fw-bolder me-1">#67890</a>resolved by merged subject data
                      </div>
                      <!--end::Title-->
                      <!--begin::Description-->
                      <div class="d-flex align-items-center mt-1 fs-6">
