        ...
        >
          ...
          <div class="rounded border border-dashed border-gray-300 p-6 p-lg-8 mb-10">
            ...
            <h2 class="fw-bolder mb-5">
              Support at
              <a href="https://chorusintel.com" class>chorusintel.com</a>
            </h2>
            <!--end::Heading-->
            <!--begin::Description-->
          ...
          <div class="d-flex align-items-center mb-7">
            ...
            <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
              ...
              <div class="d-flex flex-column me-2 me-lg-5">
                ...
                <!--end::Title-->
                <!--begin::Description-->
                <div class="text-muted fw-bold fs-7 fs-lg-6">Dynamically modify and preview layout</div>
                <!--end::Description-->
              </div>
              <!--end::Wrapper-->
