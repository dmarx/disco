  ...
  >
    ...
    >
      <div class="menu-item me-lg-1">
        <router-link class="menu-link" to="/project/studio" active-class="active">
          <span class="menu-title">Studio</span>
        </router-link>
      </div>
      <!-- <div class="menu-item me-lg-1">
        <router-link class="menu-link" to="/case/summary" active-class="active">
          <span class="menu-title">Summary</span>
        </router-link>
      </div>-->
      <div class="menu-item me-lg-1">
        <router-link class="menu-link" to="/project/admin" active-class="active">
          <span class="menu-title">Admin</span>
        </router-link>
      </div>
      <!-- <div class="menu-item me-lg-1">
        <router-link class="menu-link" to="/case/attribution" active-class="active">
          <span class="menu-title">Attribution</span>
        </router-link>
      </div>
      <div class="menu-item me-lg-1">
        <router-link class="menu-link" to="/case/dashboard" active-class="active">
          <span class="menu-title">Dashboard</span>
        </router-link>
      </div>
      <div class="menu-item me-lg-1">
        <router-link class="menu-link" to="/case/search" active-class="active">
          <span class="menu-title">Search</span>
        </router-link>
      </div>
      <div class="menu-item me-lg-1">
        <router-link class="menu-link" to="/case/workspace" active-class="active">
          <span class="menu-title">Workspace</span>
        </router-link>
      </div>
      <div class="menu-item me-lg-1">
        <router-link class="menu-link" to="/case/reports" active-class="active">
          <span class="menu-title">Reports</span>
        </router-link>
      </div>
      <div class="menu-item me-lg-1">
        <router-link class="menu-link" to="/case/admin" active-class="active">
          <span class="menu-title">Admin</span>
        </router-link>
      </div> -->
