...
parser.add_argument("--usertoken", type=str, default=default_prompt, help="prompt")
parser.add_argument("--cudaDeviceOverride", type=str, default=default_prompt, help="prompt")
