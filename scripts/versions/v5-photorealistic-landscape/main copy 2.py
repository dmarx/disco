...
settings = {
    'prompt': "A scenic close-up view of ferrofluid in a state of levitation, Hyperrealistic, by David Noton, RTX on, matte painting trending on artstation HQ.", #matte painting trending
    
  #  'prompt': "A view of a nebula, astrophotography,  trending on artstation HQ.", #matte painting trending
