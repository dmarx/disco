...
settings = {
    ...
    #'prompt': "A scenic view of a garden in summer, national geographic, Hyperrealistic, by Asher Brown Durand, RTX on, matte painting trending on artstation HQ.",
     ...
     'prompt':"A scenic view of the devil's garden, by David Noton, detailed render, I can't believe how detailed this is, matte painting trending on artstation artstation HQ.",
