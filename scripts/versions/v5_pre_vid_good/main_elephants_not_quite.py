...
#     #'prompt': "A jungle temple, by Asher Brown Durand, featured on ArtStation.",
#    # 'prompt':'A close-up view of a entire chameleon in dense jungle, by Asher Brown Durand, featured on ArtStation.',
#         #'prompt':'A scenic view of a temple carved out of the mountain landscape by Carl Jungheim and Asher Brown Durand, some mist, matte painting trending on artstation.',
#     'prompt':'Elephants drinking from a swimming pool next to a modern house, by David Shepherd and Asher Brown Durand, featured on ArtStation.',
...
#                 model_stat["target_embeds"].append(torch.tensor([np.load(model_path + "s/openimages_512x_png_embed224.npz")['arr_0']-np.load(model_path + "s/imagenet_512x_jpg_embed224.npz")['arr_0']], device = device))
#                 model_stat["weights"].append(1)
